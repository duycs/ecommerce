...
{
    public abstract class IdentityUnitOfWork<TDbContext, TAccount, TRole> : IUnitOfWork, IDisposable where TDbContext : BaseIdentityDbContext<TAccount, TRole> where TAccount : BaseAccount where TRole : BaseRole
    {
        private TDbContext _dbContext;

        private readonly ILogger<IdentityUnitOfWork<TDbContext, TAccount, TRole>> _logger;

        protected readonly IMediator _mediator;

        protected readonly IScopeContext _scopeContext;

        protected IdentityUnitOfWork(TDbContext dbContext, ILogger<IdentityUnitOfWork<TDbContext, TAccount, TRole>> logger, IMediator mediator, IScopeContext scopeContext)
        {
